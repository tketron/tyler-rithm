...
router.post('/search', async (req, res) => {
  const results = await Customer.search(req.body.searchTerm);
  res.render('customer_results.html', { results });
});

router.get('/best', async (req, res) => {
  const results = await Customer.best();
  res.render('best_customers.html', { results });
});
